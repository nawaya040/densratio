---
title: "densratio - An R Package for Density Ratio Estimation"
author: "Koji MAKIYAMA (@hoxo_m)"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{densratio - An R Package for Density Ratio Estimation}
...
- **Kernel weights** is the alpha parameters in the linear model. It was optimaized by the algorithms. You can find the whole values in `result$alpha`. 
